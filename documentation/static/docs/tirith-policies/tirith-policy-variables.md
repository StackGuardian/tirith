...
Source: https://stackguardian.github.io/tirith/docs/tirith-policies/tirith-policy-variables/
Summary: Understand how to use dynamic variables in Tirith policies for flexible policy definitions.
