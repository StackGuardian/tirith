# Creating Your First Tirith Policy

Source: https://stackguardian.github.io/tirith/docs/tirith-policies/tirith-create-first-policy/
Summary: A step-by-step guide to creating and evaluating your first Tirith policy.
