...
Source: https://stackguardian.github.io/tirith/docs/tirith-reference/evaluators/
Summary: Complete reference for all Tirith condition types, their parameters, type handling, and pass/fail semantics.
