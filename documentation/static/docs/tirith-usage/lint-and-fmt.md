...
Source: https://stackguardian.github.io/tirith/docs/tirith-usage/lint-and-fmt/
Summary: tirith lint checks policy files for mistakes that would gate nothing or fail as a false violation. tirith fmt rewrites them into one canonical layout. Neither needs a plan document.
