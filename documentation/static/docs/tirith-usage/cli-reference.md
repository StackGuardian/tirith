...
Source: https://stackguardian.github.io/tirith/docs/tirith-usage/cli-reference/
Summary: Every flag of the tirith command, what it prints, and how --json and --verbose change the output.
