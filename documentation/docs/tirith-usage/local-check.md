...
id: local-check
title: Local Check
sidebar_label: Local Check
description: The tirith local check subcommand — evaluate policy files committed in your repository, with no credentials, and get the same report platform mode produces.
keywords:
  - tirith
  - local check
  - policy as code
