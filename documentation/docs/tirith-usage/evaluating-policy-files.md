---
id: evaluating-policy-files
title: Policy Files in CI
sidebar_label: Policy Files in CI
description: Using tirith -policy-path as a CI gate — a directory of policies, a masked input, and the verdict written out for a job to publish.
keywords:
  - tirith
  - ci
  - policy as code
