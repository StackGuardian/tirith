...
sidebar_label: Platform Check
description: The tirith platform check subcommand — every flag, what it uploads, what it masks on your machine first, and what it reports back.
keywords:
  - tirith
  - platform check
  - stackguardian
