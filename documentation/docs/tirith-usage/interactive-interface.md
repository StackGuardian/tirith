...
sidebar_label: Interactive interface (beta)
description: tirith ui — explore an evaluation down to the resource that caused it, build policies from a form, and experiment in a playground.
keywords:
  - tirith
  - cli
  - tui
site_name: Tirith
slug: interactive-interface/
---
