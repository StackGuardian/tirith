---
id: tirith-policy-cookbook
title: Policy Cookbook
sidebar_label: Policy Cookbook
description: Complete, runnable Tirith policies for common real-world checks, each shown with its input and the verdict it produces.
keywords:
  - tirith
site_name: Tirith
slug: tirith-policy-cookbook/
---
