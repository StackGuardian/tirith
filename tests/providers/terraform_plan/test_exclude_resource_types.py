...
def test_exclude_resource_types_attribute():
    """Test that resources with types in exclude_resource_types are skipped when using wildcard"""
    input_data = load_json_from_fixtures("input_exclude_resource_types.json")

    # Test with exclude_resource_types
    provider_args = {
...
def test_exclude_resource_types_action():
    """Test that resources with types in exclude_resource_types are skipped when using wildcard for action operation"""
    input_data = load_json_from_fixtures("input_exclude_resource_types.json")
...
def test_exclude_resource_types_count():
    """Test that resources with types in exclude_resource_types are skipped when using wildcard for count operation"""
    input_data = load_json_from_fixtures("input_exclude_resource_types.json")
...
def test_policy_exclude_resource_types():
    """Test that the policy evaluation works correctly with exclude_resource_types"""
    input_data = load_json_from_fixtures("input_exclude_resource_types.json")
    policy = load_json_from_fixtures("policy_exclude_resource_types.json")
