...
def all_of(msg):
	...
	for i in range(len(evaluator_ref_all_of)):
		...
		"evaluator_result_all_of":evaluator_handler(msg["input_resource_changes_attr_value"][i],evaluator_data_all_of[i],evaluator_ref_all_of[i])
		}
...
def any_of(msg):
	...
	for i in range(len(evaluator_ref_any_of)):
		...
		"evaluator_result_any_of":evaluator_handler(msg["input_resource_changes_attr_value"][i],evaluator_data_any_of[i],evaluator_ref_any_of[i])
		}
		total_evaluation.append(each_evaluation)
	return total_evaluation
def none_of(msg):
	...
	for i in range(len(evaluator_ref_none_of)):
		...
		"evaluator_result_any_of":evaluator_handler(msg["input_resource_changes_attr_value"][i],evaluator_data_none_of[i],evaluator_ref_none_of[i])
		}
		total_evaluation.append(each_evaluation)
	return total_evaluation
