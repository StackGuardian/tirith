...
def provide(provider_inputs, input_data):
    ...
    exclude_types = provider_inputs.get("exclude_types", [])
    ...
    if input_type == "attribute":
        ...
        for resource_change in resource_changes:
            # Skip if resource type is in exclude_types when using wildcard
            if resource_type == "*" and resource_change["type"] in exclude_types:
                continue
