            ...
            "configuration": {
                ...
                "root_module": {
                    "outputs": {
                        ...
                        "database_subnet_group": {
                            "expression": {
                                "references": ["aws_db_subnet_group.database"]
                            },
                        ...
                        "elasticache_network_acl_arn": {
                            "expression": {
                                "references": ["aws_network_acl.elasticache"]
                            },
                        ...
                        "private_ipv6_egress_route_ids": {
                            "expression": {
                                "references": ["aws_route.private_ipv6_egress"]
                            },
                            "description": "List of IDs of the ipv6 egress route.",
                        },
                        "private_nat_gateway_route_ids": {
                            "expression": {
                                "references": ["aws_route.private_nat_gateway"]
                            },
                    ...
                    "resources": [
                        ...
                        },
                        {
                            ...
                            "schema_version": 1,
                            "count_expression": {
                                "references": ["var.manage_default_vpc"]
                            },
                        },
                        {
                        ...
                        },
                        {
                            ...
                            "expressions": {
                                ...
                                "subnet_ids": {
                                    "references": ["aws_subnet.elasticache"]
                                },
                                "tags": {
                                    "references": [
                                        "var.elasticache_subnet_group_name",
                        ...
                        },
                        {
                            ...
                            "expressions": {
                                ...
                                "log_format": {
                                    "references": ["var.flow_log_log_format"]
                                },
                            ...
                            "schema_version": 0,
                            "count_expression": {
                                "references": ["local.enable_flow_log"]
                            },
                        },
                        {
                        ...
                        },
                        {
                            ...
                            "expressions": {
                                "route_table_id": {
                                    "references": ["aws_route_table.intra"]
                                },
                                "subnet_id": {
                        ...
                        },
                        {
                            ...
                            "expressions": {
                                "amazon_side_asn": {
                                    "references": ["var.amazon_side_asn"]
                                },
                                "availability_zone": {
                                    "references": ["var.vpn_gateway_az"]
                                },
                                "tags": {
                                    "references": [
                                        "var.name",
